...
<head>
    ...
    <title>Dashboard Admin | Launnres</title>
                ...
                <nav class="mt-4">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2">
                            <a href="index_admin.php" class="nav-link text-white active">
                                ...
                                <div class="d-flex align-items-start justify-content-between">
                                    <div class="content-box">
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="icon-box bg-primary-subtle rounded p-2 me-2">
                                                <i class="fas fa-store text-primary"></i>
                                            </div>
                                            <span class="text-muted">Outlet</span>
                                        </div>
                                        <h3 class="mb-0"><?php echo $jumlah_outlet; ?></h3>
                                        <small class="text-muted">Total Outlet Aktif</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start justify-content-between">
                                    <div class="content-box">
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="icon-box bg-info-subtle rounded p-2 me-2">
